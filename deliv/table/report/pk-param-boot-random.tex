...
IIV-KA & $\Omega_{(1,1)}$ & 0.219 [CV\%=49.4] & 14.4 & 0.218 & 0.130, 0.331 \\
IIV-V2/F & $\Omega_{(2,2)}$ & 0.0824 [CV\%=29.3] & 5.51 & 0.0821 & 0.0643, 0.101 \\
IIV-CL/F & $\Omega_{(3,3)}$ & 0.114 [CV\%=34.8] & 1.25 & 0.112 & 0.0896, 0.140 \\
